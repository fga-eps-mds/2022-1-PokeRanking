  ...
  return (
    <div id="modal-braba" className="modal">
      <div className="modal-content">
        ...
        <div className="linha-horizontal"></div>
        <main className="container">
        <div><button className="bot1">{pokemonDataCard.rank.colocado_total}°</button></div>
        <div><button className="bot4">{pokemonDataCard.rank.colocado_hp}°</button></div>
        <div><button className="bot4">{pokemonDataCard.rank.colocado_attack}°</button></div>
        <div><button className="bot4">{pokemonDataCard.rank.colocado_defense}°</button></div>
        <div><button className="bot4">{pokemonDataCard.rank.colocado_special_attack}°</button></div>
        <div><button className="bot4">{pokemonDataCard.rank.colocado_special_defense}°</button></div>
        <div><button className="bot4">{pokemonDataCard.rank.colocado_speed}°</button></div>
        </main>
        </div>
        ...
        <div className="modal-footer">
          <div className="linha-horizontal"></div>
            <div className="adicionar">+</div>
              <p className="textFoot">Adicionar à equipe</p>
          </div>
      </div>
    </div>
  );
