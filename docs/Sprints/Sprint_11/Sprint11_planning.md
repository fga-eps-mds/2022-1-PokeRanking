...
* Incrementação de novas práticas agéis.
...
------ | --------- | -----------
01 | Documentar Sprint 11 | [Kallyne](https://github.com/kazpmcd)
02 | Integração contínua - CI | [Artur](https://github.com/artur-seppa)
03 | Implementação de funcionalidade dos filtros | [João](https://github.com/JoaoSchmitz) 
04 | Card de detalhes | [Thiago](https://github.com/Thiago-Cerq)
08 | Atualizar documentação de arquitetura | [Kallyne](https://github.com/kazpmcd/)
